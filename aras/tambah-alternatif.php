...
if (isset($_POST['submit'])) :
	...
	if (empty($errors)) :
		...
		redirect_to('list-sekolah.php?status=sukses-baru');
...
$query = $pdo->prepare('SELECT MAX(no_kalung) as max_a FROM kambing');
$query->execute();
// $query->setFetchMode(PDO::FETCH_ASSOC);
$max_alternatif = $query->fetch();
$max_alternatif = substr($max_alternatif['max_a'], 1);
$max_alternatif++;
if ($max_alternatif == 0) {
	$max_alternatif = 1;
}
$alternatif = 'A' . $max_alternatif;
?>
...
<div class="main-content-row">
	<div class="container clearfix">
		...
		<div class="main-content the-content">
			...
			<form action="tambah-sekolah.php" method="post">
				<div class="field-wrap clearfix">
					<label>Alternatif<span class="red">*</span></label>
					<input type="text" name="no_kalung" value="<?php echo $alternatif; ?>" readonly style="background: #bfbfbf">
				</div>
				<div class="field-wrap clearfix">
